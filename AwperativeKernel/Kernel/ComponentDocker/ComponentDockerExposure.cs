...
public abstract partial class ComponentDocker
{
    ...
    public bool Contains(string __tag) => Guard.NotNull(__tag) && _componentTagDictionary.ContainsKey(__tag);
    ...
    [MarkerAttributes.Expense(MarkerAttributes.Expense.ExpenseLevel.VeryLow), MarkerAttributes.Complexity(MarkerAttributes.Complexity.TimeComplexity.O1)]
    public bool Contains<__Type>(string __tag) where __Type : Component => Guard.NotNull(__tag) && GetAll<__Type>(__tag).Any();
    ...
    [MarkerAttributes.Expense(MarkerAttributes.Expense.ExpenseLevel.VeryLow), MarkerAttributes.Complexity(MarkerAttributes.Complexity.TimeComplexity.O1)]
    public bool Contains(Component __component) => Guard.NotNull(__component) && _componentTypeDictionary.TryGetValue(__component.GetType(), out var components) && components.Contains(__component);
    ...
    public IEnumerable<Component> GetAll(IEnumerable<string> __tags) {
        if (!Guard.EnumerableNotNull(__tags)) return [];
    ...
    public IEnumerable<__Type> GetAll<__Type>(IEnumerable<string> __tags) where __Type : Component {
        if (!Guard.NotNull(__tags) || !__tags.Any()) return [];
